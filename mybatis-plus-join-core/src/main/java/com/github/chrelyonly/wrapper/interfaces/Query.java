...
import com.github.chrelyonly.wrapper.enums.DefaultFuncEnum;
import com.github.chrelyonly.wrapper.segments.*;
...
public interface Query<Children> extends Serializable {
     ...
     *
     * @param funcEnum 函数枚举 {@link com.github.chrelyonly.wrapper.enums.DefaultFuncEnum}
